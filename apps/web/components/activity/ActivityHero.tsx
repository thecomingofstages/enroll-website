  ...
  return (
    <header className="relative isolate h-[min(52vh,420px)] w-full overflow-hidden bg-zinc-900">
      ...
      <div className="absolute inset-x-0 bottom-0 mx-auto max-w-3xl px-4 pb-10 pt-24 text-white">
        <p className="font-kanit text-sm font-bold tracking-widest text-[var(--color-gold)] uppercase mb-2">
          {activity.venue?.name}
        </p>
        <h1 className="text-balance font-trirong text-4xl leading-tight text-white drop-shadow-md sm:text-5xl">
          {activity.name}
        </h1>
      </div>
    </header>
