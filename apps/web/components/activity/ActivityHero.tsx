      ...
      <div className="absolute inset-x-0 bottom-0 mx-auto max-w-3xl px-4 pb-10 pt-24 text-white">
        <div className="mb-3 flex flex-wrap items-center gap-3">
          {activity.seat_capacity > 0 && (
            <div className="flex items-center gap-1.5 rounded-md backdrop-blur-md px-3 py-1 text-xs font-semibold tracking-wide text-gold shadow-sm">
              <svg className="h-3.5 w-3.5 opacity-90" fill="gold" viewBox="0 0 20 20">
                <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" />
              </svg>
              <span>{activity.enrolled_count} / {activity.seat_capacity}</span>
            </div>
          )}
        </div>
        <h1 className="text-balance text-4xl font-trirong font-semibold leading-tight text-white drop-shadow-md sm:text-5xl">
          {activity.name}
        </h1>
      </div>
    </header>
