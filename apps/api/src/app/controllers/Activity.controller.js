...
class ActivityController {
  ...
  static async list(req, res, next) {
    try {
      const filters    = { tags: req.query.tags, is_featured: req.query.is_featured, is_registration_open: req.query.is_registration_open };
      ...
      Logger.error(`[ActivityController.list] ${err.message}`);
      next(err);
    }
  }
  ...
  static async getRecommended(req, res, next) {
    try {
      ...
      Logger.error(`[ActivityController.getRecommended] ${err.message}`);
      next(err);
    }
  }
  ...
  static async getById(req, res, next) {
    try {
      ...
      Logger.error(`[ActivityController.getById] ${err.message}`);
      next(err);
    }
  }
  ...
  static async remove(req, res, next) {
    try {
      ...
      Logger.error(`[ActivityController.remove] ${err.message}`);
      next(err);
    }
  }
}
